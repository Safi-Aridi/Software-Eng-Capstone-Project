...
const KycSubmissionPanel = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      alert(
        "Identity document submitted successfully! Identity information will be extracted automatically.",
      );
    ...
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          You must complete identity verification before accessing passport
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        ...
        <p className="text-blue-700 text-sm">
          Identity information will be extracted automatically from your
          submitted document. Your account will remain limited until
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        >
          {isSubmitting ? "Submitting..." : "Submit Identity Document"}
        </button>
      </form>
    </div>
  );
